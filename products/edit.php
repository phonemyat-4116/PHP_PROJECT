                ...
                <form action="update.php?id=<?php echo $product->id ?>" method="POST">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            ...
                            <input type="text" id="name" name="name" class="form-control form-control-sm" value="<?php echo $product->name ?>" autocomplete="off" required/>
                        </div>

                        <div class="col-12 my-3">
                            <label for="price" class="text-uppercase my-2" style="font-weight: bold;">Price</label>
                            <input type="text" id="price" name="price" class="form-control form-control-sm" value="<?php echo $product->price ?>" autocomplete="off" required/>
                        </div>

                        <div class="col-12 mb-4">
                            <label for="stock" class="text-uppercase my-2" style="font-weight: bold;">Stock</label>
                            <input type="text" id="stock" name="stock" class="form-control form-control-sm" value="<?php echo $product->stock ?>" autocomplete="off" required/>
                        </div>

                        <div class="col-12">
                            <label for="description" class="text-uppercase my-2" style="font-weight: bold;">Description</label>
                            <textarea id="description" name="description" class="form-control form-control-sm" autocomplete="off" required><?php echo $product->description ?></textarea>
                        </div>

                        <div class="col-12 mb-4">
                            <label for="category_id" class="text-uppercase my-2" style="font-weight: bold;">Category</label>
                            <select class="form-select" id="category_id" name="category_id" required aria-label="Default select example" required>
                        ...
                        <div class="d-flex">
                            ...
                            <button class="btn btn-secondary btn-sm w-100 mt-3 ms-2"><a href="index.php" class="text-white" style="text-decoration: none;">Back</a></button>
                        </div>
                    </div>
                </form>
                <!-- form end -->
